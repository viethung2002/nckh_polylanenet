...
if __name__ == "__main__":
    ...
    fourcc = cv2.VideoWriter_fourcc(*'XVID')  # Try a different codec
    out = cv2.VideoWriter('output.mp4', fourcc, fps, (w, h))  # Use w, h directly
    ...
    while True:
        ...
        image = predict_on_image(model, frame_resize, test_parameters)
        print(f'Frame: {now_frame}/{total_frames}')
    ...
    # img = predict_on_image(model, img, test_parameters, save=False)
